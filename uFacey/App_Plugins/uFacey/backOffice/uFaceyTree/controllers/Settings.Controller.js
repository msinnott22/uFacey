angular.module("umbraco").controller("uFacey.SettingsController",
    function($scope, $routeParams, settingsResource, notificationsService, localizationService, navigationService) {
        ...
        settingsResource.getVersion().then(function(response) {
        ...
        navigationService.syncTree({ tree: tree, path: ["-1", $routeParams.id], forceReload: false });
